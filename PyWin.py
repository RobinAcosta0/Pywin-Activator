...
class main_window:
	...
	def __init__(self):
		...
		button_appautor = Button(root, font=font_buttons,text="GitHub", width=20, height=8,bg="#FFBB00", fg="black", command=lambda:webbrowser.open("https://www.instagram.com/arobin404/"))
		button_appautor.grid(row=4, column=1, padx=5, pady=5)
